...
let tray = initTray(
  ...
  menus = [
    ...
    initTrayMenuItem(
      text = "Submenu",
      submenus = [
        initTrayMenuItem(text = "FIRST", checked = true, cb = submenu_cb),
        initTrayMenuItem(
          text = "SECOND",
          submenus = [
            initTrayMenuItem(
              text = "THIRD",
              submenus = [
                initTrayMenuItem(text = "7", cb = submenu_cb),
                initTrayMenuItem(text = "-"),
                initTrayMenuItem(text = "8", cb = submenu_cb)
              ]
            ),
            initTrayMenuItem(
              text = "FOURTH",
              submenus = [
                initTrayMenuItem(text = "5", cb = submenu_cb),
                initTrayMenuItem(text = "6", cb = submenu_cb)
              ]
            )
          ]
        )
